...
public class AndroidNotifikacijaBrodcastReceiver extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        Log.d("notifikacija","Nešto se događa");
        ...
        RemoteViews contentView = new RemoteViews(context.getPackageName(), R.layout.oblik_notifikacije);
